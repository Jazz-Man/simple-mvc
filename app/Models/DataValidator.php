...
class DataValidator extends Model
{
	 ...
	 * @throws \Exception
	 */
	public function filter(array $input, array $filterset): array
	{
	 ...
	 * @return array
	 */
	public function sanitize(array $input, array $fields = [], $utf8_encode = true): array
	{
	 ...
	 * @return bool
	 */
	protected function shouldRunValidation(array $input, $rules, $field): bool
	{
	 ...
	 * @return string
	 */
	protected function filter_noise_words($value): string
	{
	 ...
	 * @return string
	 */
	protected function filter_basic_tags($value): string
	{
	 ...
	 * @return int
	 */
	protected function filter_whole_number($value): int
	{
		return (int) $value;
	}
	...
	protected function validate_starts($field, $input, $param = null)
	{
		...
		if (mb_strpos($input[$field], $param) !== 0) {
			return [
				'field' => $field,
				'value' => $input[$field],
				'rule' => __FUNCTION__,
